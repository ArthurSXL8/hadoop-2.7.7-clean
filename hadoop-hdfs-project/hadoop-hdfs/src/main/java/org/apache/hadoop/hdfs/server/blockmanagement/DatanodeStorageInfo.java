...
public class DatanodeStorageInfo {
   ...
   */
  class BlockIterator implements Iterator<BlockNeighborInfo> {
    private BlockNeighborInfo current;

    BlockIterator(BlockNeighborInfo head) {
      this.current = head;
    }
  ...
  private volatile BlockNeighborInfo blockList = null;
  ...
  public boolean removeBlock(BlockNeighborInfo b) {
   ...
   */
  int moveBlockToHead(BlockNeighborInfo b, int curIndex, int headIndex) {
   ...
   */
  @VisibleForTesting
  BlockNeighborInfo getBlockListHeadForTesting(){
    return blockList;
  }
